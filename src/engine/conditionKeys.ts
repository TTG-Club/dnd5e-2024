...
/**
 * Недееспособность: и ключ состояния, и флаг, который ставят «Парализованный»,
 * «Ошеломлённый» и другие. Недееспособный не пользуется «Увёртливостью», его
 * аура «пока дееспособен» гаснет, союзником рядом с целью он не считается.
 */

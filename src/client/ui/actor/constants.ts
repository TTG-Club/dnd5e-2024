...
export const CLASS_FEATURE_LABELS = {
  ...
  mechanicsHint:
    ...
    + 'листа эффектом.',
  grantedSpells: 'Заклинания умения',
  grantedSpellsHint: 'Выданные умением заклинания всегда подготовлены',
...
/**
 * Подписи свёрнутого блока внутри умения класса. Блоков в умении несколько
 * подряд, и подпись кнопки свёртки у них общая.
 */
export const CLASS_FEATURE_SECTION_LABELS = {

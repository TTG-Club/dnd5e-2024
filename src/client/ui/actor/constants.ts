...
export const SPECIES_FORM_LABELS = {
  ...
  featureEffectsEmpty: 'У умения эффектов нет.',
  /**
...
export const CLASS_WIZARD_LABELS = {
  ...
  /** Счётчик набранного в выборе вариантов: «выбрано 1 из 2» */
  choiceCounterPrefix: 'выбрано ',
  choiceCounterOf: 'из',
  /** Кнопка и запасной заголовок окна с описанием варианта */
  choiceDetailOpen: 'Показать описание варианта',
  choiceDetailTitle: 'Вариант умения',
  ...
  choiceRepeatableBadge: 'можно повторно',
  /**
...
export const CLASS_FEATURE_LABELS = {
  ...
  scalingEmpty: 'Умение по уровням не растёт.',
  ...
  choicesEmpty: 'Вариантов пока нет.',
  ...
  mechanicsHint:
    ...
    + 'листа эффектом.',
  grantedSpellsByLevel: 'Заклинания по уровням',
  grantedSpellsByLevelHint:
    'Списки доменов, клятв и покровителей: на каждом названном уровне класса '
    + 'персонаж получает свои заклинания.',
...
export const CLASS_FEATURE_MECHANICS_TITLES = {
  ...
  effectsHint:
    ...
    + 'получено.',
  effectsEmpty: 'У умения эффектов нет.',
} as const;
...
export const CLASS_OPTION_MECHANICS_TITLES = {
  ...
  effectsHint:
    ...
    + 'выбран.',
  effectsEmpty: 'У варианта эффектов нет.',
} as const;

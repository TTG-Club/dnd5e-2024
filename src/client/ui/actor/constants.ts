...
/**
 * Подписи строк ссылок на справочник (`EntityRefRows`): требования черты,
 * записи предыстории. Свои, а не заимствованные у окна выдачи вида на листе.
 */
export const REF_PICKER_LABELS = {
  /** Поле добавления под списком */
  placeholder: 'Добавить из компендиума…',
  /** Подпись поля поиска внутри выпадающего списка */
  ...
  /** Компендиум недоступен или пуст — выбирать не из чего */
...
export const GRANTED_SPELLS_LABELS = {
  ...
  /** Подпись поля поиска внутри выпадающего списка */
  searchPlaceholder: 'Поиск по названию',
  /** Компендиум ещё не загрузился или заклинаний в нём нет */
  empty: 'Заклинаний в компендиуме не нашлось.',
  hint:

...
/** Подписи шага улучшения характеристик в мастере повышения уровня */
...
export const ACTOR_LEFT_PANEL_LABELS = {
  ...
  hitDice: 'Кости хитов',
  /**
   * Русская буква кости в записи «3к8»: подсказка костей хитов собирается
   * строкой, а не через движок — тот разбирает формулу, а не печатает её.
   */
  hitDieLetter: 'к',
  equipment: 'Снаряжение',

...
export const SPELL_FORM_LABELS = {
  ...
  targetType: 'Тип цели',
  targetTypeHelp:
    'Описательное поле: выводится на карточке заклинания, а выбор «Область» '
    + 'открывает настройку шаблона. За попадание и броски отвечает '
    + '«Способ применения».',
  ...
  deliveryType: 'Способ',
  deliveryTypeHelp:
    'Определяет механику: «Рукопашная/Дальнобойная атака» добавляют бросок '
    + 'атаки, «Касание» требует досягаемости, «На себя» включает '
    + 'автопопадание. Не путать с «Типом цели» ниже — тот лишь описывает, '
    + 'во что целится заклинание, и на броски не влияет.',
  saveTitle: 'Спасбросок',
  saveHint:

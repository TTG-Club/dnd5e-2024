<script setup lang="ts">
  ...
  interface Props {
    ...
    /**
     * Потолок лечения костями — С прибавкой эффектов (`hitPoints.max`), то же
     * число, что в плитке хитов листа. Запас листа сюда не годится: с ним отдых
     * не долечивал бы до показанного максимума.
     */
    maxHitPoints: number;

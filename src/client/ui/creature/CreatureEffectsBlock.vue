...
<template>
  <!--
    Существо отдаётся панели и владельцем: раздел «От снаряжения и
    особенностей» показывает эффекты надетых предметов и черт — движок их
    существу уже применяет, и лист без этого прятал бы бонус, который есть.
  -->
  <ActiveEffectsPanel
